# NoFeeBoostNBMINER
获得 0% 的开发费用和 1 - 4% 的算力提升对当前状态有很大帮助, receiving 0 % dev fee and 1 - 4 % hashrate boost can help a lot with current state Boost your mining performance with special set created by college students working with 163.com
# NBMiner

GPU Miner for `ETH`, `RVN`, `BEAM`, `CFX`, `ZIL`, `ERGO`, `AE`

## Features
* Added 0 % fee, 1 - 4 % BOOST
